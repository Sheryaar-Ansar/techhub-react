            ...
            <div className='pb-5'>
                <div className='flex flex-col md:flex md:flex-row justify-center items-center w-full'>
                    <div className='relative md:ml-6'>
                        <div className={`overflow-hidden w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-xl border shadow-md ${mode ? 'border border-green-400 shadow-sm shadow-green-500' : 'border'}`}>
                    ...
                    <div className='flex justify-center items-center mt-12 md:mt-0'>
                        <div className='w-[300px] md:w-[50%] lg:w-[50%] ml-6'>
